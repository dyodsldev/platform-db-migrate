...
WITH source AS (
    SELECT * FROM {{ ref('medicaldb.patient_latest_data') }}
),
...
cleaned AS (
    SELECT
        ...
        -- ============================================
        -- KIDNEY FUNCTION (No GFR in latest data)
        -- ============================================
        ...
        urinAlbuminCreatinineUnit AS urine_albumin_creatinine_unit,
        urineAlbuminCreatinineUnit AS urine_albumin_creatinine_unit_alt,
